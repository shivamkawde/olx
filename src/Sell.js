...
function Sell() {
  ...
  let modelname = useRef(null);
  let company = useRef(null);
  let price = useRef(null);
  let description = useRef(null);
  let [imageURL, setImageURL] = useState();
  let [loding, setLoding] = useState(false);
  let [successBox, setSuccess] = useState(false);
  console.log(city);
  return (
    <>
      <Navbar />
      ...
      {successBox ? (
        ...
        <div className="sellDiv">
          ...
          <input
            ...
            ref={modelname}
            type="text"
            placeholder="Ente Mobile/Laptop/Bike Name"
          ></input>
          <input
            className="input"
            style={{ marginTop: "2px" }}
              ...
              if (type === "video") {
                ...
                let f3 = () => {
                  uploadtask.snapshot.ref.getDownloadURL().then((url) => {
                    ...
                    firestore.collection("newposts").add({
          ...
          {loding ? (
            ...
            <button
              ...
              onClick={() => {
                if (Address.current.value && city) setSuccess(true);
